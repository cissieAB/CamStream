...
class pithermalcam:
    ...
    def _pull_raw_image(self):
        ...
        try:
            ...
            self._temp_min_ = np.min(self._raw_image)
            self._temp_max = np.max(self._raw_image)
            self._temp_range_min = 20
            self._temp_range_max = 38
    ...
    def _temps_to_rescaled_unit(self, f, Tmin, Tmax, scale_min=20, scale_max=60, temp_threshold=30 ):
